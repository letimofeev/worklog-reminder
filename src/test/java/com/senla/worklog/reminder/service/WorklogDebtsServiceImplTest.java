...
class WorklogDebtsServiceImplTest {
    ...
    private static final List<Worklog> worklogs = List.of(
            new Worklog()
                    ...
                    .setDateStarted(LocalDateTime.of(2022, 2, 6, 0, 0,0))
                    .setTimeSpentSeconds(3600 * 3L),
            new Worklog()
                    .setId(2L)
                    .setJiraWorklogId(102L)
                    .setAuthor(authors.get(1))
                    .setDateStarted(LocalDateTime.of(2022, 2, 7, 0, 0,0))
                    .setTimeSpentSeconds(3600 * 7L),
            new Worklog()
                    .setId(4L)
                    .setJiraWorklogId(104L)
                    .setAuthor(authors.get(1))
                    .setDateStarted(LocalDateTime.of(2022, 2, 9, 0, 0,0))
                    .setTimeSpentSeconds(3600 * 8L),
            new Worklog()
                    .setId(6L)
                    .setJiraWorklogId(106L)
                    .setAuthor(authors.get(1))
                    .setDateStarted(LocalDateTime.of(2022, 2, 10, 0, 0,0))
                    .setTimeSpentSeconds(3600 * 8L),
            new Worklog()
                    .setId(5L)
            ...
            new Worklog()
                    ...
                    .setAuthor(authors.get(0))
                    .setDateStarted(LocalDateTime.of(2022, 2, 8, 0, 0,0))
                    .setTimeSpentSeconds(3600 * 8L)
    );
    ...
    void findAllForPeriod_shouldReturnExpectedDebts_whenInputIsDates() {
        ...
        List<DayWorklogDebt> employee0Debts = List.of(
                new DayWorklogDebt()
                        .setDate(LocalDate.of(2022, 2, 6))
                        .setTimeDeptSeconds(requiredDaySpentSeconds - 3600 * 7L),
                new DayWorklogDebt()
                        .setDate(LocalDate.of(2022, 2, 7))
                        .setTimeDeptSeconds(requiredDaySpentSeconds),
                new DayWorklogDebt()
                        .setDate(LocalDate.of(2022, 2, 9))
                        .setTimeDeptSeconds(requiredDaySpentSeconds),
                new DayWorklogDebt()
                        .setDate(LocalDate.of(2022, 2, 10))
                        .setTimeDeptSeconds(requiredDaySpentSeconds));
