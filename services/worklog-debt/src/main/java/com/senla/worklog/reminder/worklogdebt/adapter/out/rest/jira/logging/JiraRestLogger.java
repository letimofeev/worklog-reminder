...
public class JiraRestLogger implements LogMessageBuilder {
    ...
    @Override
    public String buildRequestLogMessage(HttpRequestLog request) {
        return buildRequestLogMessage(DEFAULT_DESCRIPTION, request);
    }

    @Override
    public String buildRequestLogMessage(String header, HttpRequestLog request) {
