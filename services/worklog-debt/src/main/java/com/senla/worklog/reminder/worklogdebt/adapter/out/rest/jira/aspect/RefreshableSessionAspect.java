package com.senla.worklog.reminder.worklogdebt.adapter.out.rest.jira.aspect;

import com.senla.worklog.reminder.worklogdebt.adapter.out.rest.jira.auth.JiraAuthenticationException;
...
public class RefreshableSessionAspect {
    ...
    @Around("@annotation(com.senla.worklog.reminder.worklogdebt.adapter.out.rest.jira.auth.RefreshableSession)")
