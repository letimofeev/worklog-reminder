package com.senla.worklog.reminder.exception.wrapper;
...
public class ExceptionWrapperAspect {
     ...
     */
    @Around("@within(com.senla.worklog.reminder.exception.wrapper.annotation.WrappedInApplicationException)")
