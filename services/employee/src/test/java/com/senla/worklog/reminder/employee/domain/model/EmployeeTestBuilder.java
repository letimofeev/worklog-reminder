...
public class EmployeeTestBuilder {
    ...
    public static final boolean TEST_NOTIFICATION_ENABLED = false;
    public static final boolean TEST_BOT_CONNECTED = true;
    ...
    public EmployeeTestBuilder restEmployee() {
        employee.setNotificationEnabled(TEST_NOTIFICATION_ENABLED)
